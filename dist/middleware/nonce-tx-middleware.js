...
var NonceTxMiddleware = /** @class */ (function () {
    function NonceTxMiddleware(client) {
        this._client = client;
    }
    NonceTxMiddleware.prototype.Handle = function (txData, localAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var privateKey, publicKey, key, nonce, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        privateKey = this._client.getPrivateKey(localAddress);
                        publicKey = crypto_utils_1.publicKeyFromPrivateKey(privateKey);
                        key = crypto_utils_1.bytesToHex(publicKey);
