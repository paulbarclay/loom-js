...
export declare class Contract extends EventEmitter {
     ...
     */
    callAsync<T extends Message | void>(caller: Address, method: string, args: Message, output?: T): Promise<T | void>;
    /**
     ...
     */
    staticCallAsync<T extends Message>(caller: Address, method: string, args: Message, output: T): Promise<T>;
