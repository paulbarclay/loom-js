...
export declare class EvmContract extends EventEmitter {
     ...
     */
    callAsync(caller: Address, args: number[], output?: Uint8Array): Promise<Uint8Array | void>;
    /**
     ...
     */
    staticCallAsync(caller: Address, args: number[], output?: Uint8Array): Promise<Uint8Array | void>;
