...
tape_1.default('SparseMerkleTree', function (t) {
    try {
...
*/
function testEmptySMT(t) {
    var emptyTree = new sparse_merkle_tree_1.SparseMerkleTree(64, {});
...
*/
//# sourceMappingURL=sparse-merkle-tree-tests.js.map