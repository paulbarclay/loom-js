...
var InvalidNonceTxMiddleware = /** @class */ (function () {
    function InvalidNonceTxMiddleware(client) {
        this.failureCount = 0;
        this.currentAttempt = 0;
        this._mw = new index_1.NonceTxMiddleware(client);
    }
    InvalidNonceTxMiddleware.prototype.Handle = function (txData, localAddress) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (this.currentAttempt++ < this.failureCount) {
                    ...
                    return [2 /*return*/, this._mw.Handle(txData, localAddress)];
                }
                return [2 /*return*/];
            });
        });
...
tape_1.default('Client nonce retry strategy', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                nonceMiddlware = new InvalidNonceTxMiddleware(client);
                client.txMiddleware = [nonceMiddlware, new index_1.SignedTxMiddleware(client)];
            ...
            case 2:
                _a.trys.push([2, 4, , 5]);
                return [4 /*yield*/, contract.callAsync(callerAddr, 'SetMsg', msg)];
            case 3:
                _a.sent();
                return [3 /*break*/, 5];
            case 4:
